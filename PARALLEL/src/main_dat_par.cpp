...
int main(int argc, char* argv[]) {
    ...
    cout << "===================================================\n";
    cout << "      DATA PARALLEL MATCHING BENCHMARK       \n";
    cout << "===================================================\n";
    ...
    try {
        ...
        // PARALLEL COMPUTING
        cout << ">>> Starting processing [DATA PARALLELISM ACROSS TIME SERIES]...\n";

        auto start_compute = high_resolution_clock::now();

        vector<match_result> results = dat_par_finder(flat_queries, config.query_length, flat_data, data_offsets);
