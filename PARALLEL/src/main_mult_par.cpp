...
int main(int argc, char* argv[]) {
    ...
    cout << "===================================================\n";
    cout << "  MULTIPLE QUERY PARALLEL MATCHING BENCHMARK \n";
    cout << "===================================================\n";
    ...
    try {
        ...
        // PREPARATION and FLATTENING PHASE
        ...
        // parallel computing
        cout << ">>> Starting processing [COARSE-GRAINED QUERY PARALLELISM]...\n";

        auto start_compute = high_resolution_clock::now();

        vector<match_result> results = mult_par_finder(flat_queries, config.query_length, flat_data, data_offsets);
