...
#ifndef FIRST_ASSIGNMENT_MATCHRESULT_H
#define FIRST_ASSIGNMENT_MATCHRESULT_H
...
struct MatchResult {
    ...
    MatchResult(std::size_t id, std::size_t idx, real_t dist)
            : series_id(id),
              start_index(idx),
              distance(dist) {}
...
#endif //FIRST_ASSIGNMENT_MATCHRESULT_H
